...
router.post("/login", (req, res, next) => {
	console.log("Starting local authentication...")
	passport.authenticate(
		...
		(
			...
			req.login(user, (loginErr) => {
				...
				console.log("Login successful. User session initialized:", req.session)
				console.log("req.user after login:", req.user) // Ensure `req.user` is set
